...
export function getTransactions(address, offset) {
  const offset2 = 1000
  const url = `https://api.etherscan.io/api?module=account&action=txlist&address=${address}&startblock=0&endblock=999999999999&page=1&offset=${offset2}&sort=asc&apikey=${API_KEY}`
